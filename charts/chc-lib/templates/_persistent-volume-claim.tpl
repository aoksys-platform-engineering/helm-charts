{{/*
Template to generate a "PersistentVolumeClaim" manifest from.

See "https://kubernetes.io/docs/reference/generated/kubernetes-api/latest/#persistentvolumeclaim-v1-core" for the full API spec.
...
{{- define "chc-lib.persistent-volume-claim.tpl" }}
{{- $ctx := .context }}
{{- if .values.create }}
---
apiVersion: v1
